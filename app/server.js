...
const youtube = new YouTube("AIzaSyAt64jID5wgA6xeNsIwmPJDtwFIulyIimE"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyAt64jID5wgA6xeNsIwmPJDtwFIulyIimE"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@739140586636050504>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
نتأسف الموسيقى لا تعمل وسيتم إصلاح المشكل قريبا
...
client.on("message", message => {
  if (!message.guild || message.author.bot) return;
  if (message.content == prefix + "ألوان") {
...
client.on("message", message => {
  if (message.content === "نورتنا") {
    message.channel.send("**:heart:بنورك:heart:**");
    message.channel.sendFile("");
  }
});
